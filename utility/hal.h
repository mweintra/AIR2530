...
#define RADIO_ON()                  ( digitalWrite(MRSTpin,HIGH) )
#define RADIO_OFF()                 ( digitalWrite(MRSTpin,LOW) )
#define SPI_SS_SET()                ( digitalWrite(MRDYpin,LOW) ) 	//MRDY tied to CS in hardware?
#define SPI_SS_CLEAR()              ( digitalWrite(MRDYpin,HIGH) )
#define SRDY_IS_HIGH()              ( digitalRead(SRDYpin)==HIGH )
#define SRDY_IS_LOW()               ( digitalRead(SRDYpin)==LOW )
